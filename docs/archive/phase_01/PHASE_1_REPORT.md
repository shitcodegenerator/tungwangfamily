...
docs/archive/phase_01/PHASE_1_PROJECT_PLAN.md, docs/archive/phase_01/LOCAL_AI_PHASE_1_PROMPT.md, docs/archive/phase_01/PHASE_1_REPORT.md, docs/screenshots/*.png
```
...
- 完整素材需求清單見 `docs/archive/asset_requests/ASSET_REQUEST.md`。
