...
規劃來源：`docs/archive/phase_04/PHASE_4_PLAN.md`、`docs/archive/phase_04/LOCAL_AI_PHASE_4_PROMPT.md`、`docs/archive/phase_04/PHASE_4_ASSET_README.md`、
...
docs/archive/phase_04/PHASE_4_REPORT.md、docs/screenshots/12～18
...
docs/MANUAL_TEST_GUIDE.md、README.md、AGENTS.md、docs/archive/asset_requests/ASSET_REQUEST.md
```
...
- **損毀素材**：分支上妹妹行動表、阿嬤、洞窟三個檔案都不是 PNG；妹妹與阿嬤已由作者提供原圖補上，`CAVE_fried_food_demon_arena_reference.png` 仍需重新交付（見 `docs/archive/asset_requests/ASSET_REQUEST.md` D 節）。
