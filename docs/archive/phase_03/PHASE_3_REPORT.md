...
規劃來源：`docs/archive/phase_03/PHASE_3_PLAN.md`、`docs/PHASE_3_DECISIONS.md`、`docs/archive/phase_03/LOCAL_AI_PHASE_3_PROMPT.md`；
...
docs/archive/phase_03/PHASE_3_REPORT.md、docs/screenshots/09_family_home.png、10_captain_room.png、11_quest_log.png
...
- A11／A12 過渡 tile 仍待重產（見 `docs/archive/asset_requests/ASSET_REQUEST.md`）。
